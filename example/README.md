...
You can compare the generated matvec_rpc_stubs.f90 to matvec_server.f90 to see the implementation details of this simple server.  The former file is generated when running Hermes to produce Fortran RPC as a template for implementing your server (stubbed out interfaces).  The matvec_rpc_stubs.py is produced with generating the Python RPC and provides a starting place to implement a Python based server (not used in this example).
